...
class FenaPaymentProviderService extends AbstractPaymentProvider<FenaPaymentProviderOptions> {
    ...
    private async resolveBrandKeysFromCartId(
        cartId: string
    ): Promise<string[]> {
        ...
        if (!cartModule?.retrieveCart) return []
    ...
    private async resolveBrandKeysFromPaymentSessionId(
        sessionId: string
    ): Promise<string[]> {
